...
//For Deleting the notice
    if ($_GET['id']) {
        $id = $_GET['id'];
        $sql = "delete from tblimageadd where image_id=:id";
                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">Manage Image</h2>
                            </div>
                            <!-- /.col-md-6 text-right -->
                        </div>
                        <!-- /.row -->
                                                    ...
                                                    foreach ($results as $result) { ?>
                                                        <tr>
                                                            ...
                                                            <td><img style="width:50px;height:50px;"
                                                                     src="<?= htmlspecialchars($result->header_image) ?>"
                                                                     alt="yo'q rasm"></td>
                                                            <td>
                                                                <a style=" margin-top: 10px;"
                                                                   href="manage-image.php?id=<?php echo htmlentities($result->image_id); ?>"
